...
Deque is thread-safe, but LinkedList/List are not thread-safe, can we make use Linked List / List and make it thead-safe here?
...
class BoundedBlockingQueue(object):
    ...
    def __init__(self, capacity: int):
        ...
        self.enque = Semaphore(self.capacity)
