...
from each step to next step, we use BFS to explore all its neighbors, using steps as cost, to try to get to next height tree location with least number of steps
