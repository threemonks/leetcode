...
from leetcode.lc_tools import Node, listToNaryTree
...
def main():
    sol = Solution()
    assert sol.findRoot(listToNaryTree([1,None,3,2,4,None,5,6])) == listToNaryTree([1,None,3,2,4,None,5,6]), 'fails'

    assert sol.findRoot(listToNaryTree([1,None,2,3,4,5,None,None,6,7,None,8,None,9,10,None,None,11,None,12,None,13,None,None,14])) == listToNaryTree([1,None,2,3,4,5,None,None,6,7,None,8,None,9,10,None,None,11,None,12,None,13,None,None,14]), 'fails'
